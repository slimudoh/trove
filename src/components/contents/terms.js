    ...
    <div>
      ...
      <div className="terms">
        <div className="terms__bg--content main__container">
          ...
          <div className="terms__bg--content-right">
            <p>Effective date: August 08, 2018</p>
            <div>
              Trove & Trove Technologies Limited ("us", "we", or "our") operates
              the troveapp.co website and the Trove mobile application (the
              "Service").
              <br />
              <br />
              ...
              Use of Data
              <br />
              Trove & Trove Technologies Limited uses the collected data for
              various purposes:
              <br />
              <br />
              ...
              <br />
              <br />
              Trove & Trove Technologies Limited will take all steps reasonably
              ...
              Disclosure Of Data
              <br />
              Trove & Trove Technologies Limited may disclose your Personal Data
              in the good faith belief that such action is necessary to:
              <br />
              <br />
              To comply with a legal obligation
              <br />
              To protect and defend the rights or property of Trove & Trove
